...
export class InjectionManager {
  ...
  generateModuleInjector(pluginDefinition: MVDHosting.DesktopPluginDefinition, launchMetadata: any, instanceId: any): Injector {
    ...
    return Injector.create([
      ...
      {
        provide: Angular2InjectionTokens.WINDOW_INSTANCE_ID,
        useValue: instanceId
      }
