...
@Injectable()
export class L10nPluginStorageService implements L10nStorage {
  ...
  public async write(_l11Locale: L10nLocale): Promise<void> {
    // plugins are not allowed to change language globally
  }
